...
function pageText(pageModel,method){
	var currentPage=pageModel.currentPage,allPageNumber=pageModel.allPageNumber,allObjectNumber=pageModel.allObjectNumber,pageNumber=pageModel.pageNumber;
	...
	if(currentPage==1){
		//pageText=pageText+"<li class=\"prev disabled\"><a href=\"javascript;\">上一页</a></li>";
	      pageText=pageText+"<li class=\"prev disabled\">上一页</li>";
	}else{
	...
	if(currentPage==allPageNumber){
		//pageText=pageText+"<li class=\"next disabled\"><a href=\"javascript;\">下一页</a></li>";
	     pageText=pageText+"<li class=\"next disabled\">下一页</li>";
	}else{
