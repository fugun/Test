...
public interface AppMapper extends SysMapper<AppUserInfo>{
	...
	// 新增代理审核
	public Integer addagency(AgencycashrecordInfo ag);
	public List<Map<String,Object>> findAgency(Map<String,Object> ag);
	
	public List<Map<String,Object>> findAgencyCheck(AgencycashrecordInfo ag);
	public Integer updateAgencyCheck(AgencycashrecordInfo ag);
