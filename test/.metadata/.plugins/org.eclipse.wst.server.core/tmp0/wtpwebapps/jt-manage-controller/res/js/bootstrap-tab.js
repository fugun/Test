var addTabs = function (options) {
    ...
    if (!$("#tab_" + id)[0]) {
        ...
        title = '<li id=tabtitle_' + id + '> <a class="icon-remove" style = "float:right" onclick="javascript:closeTab(' + id + ');"> <a href="#tab_' + id + '" data-toggle="tab"><nobr>' + options.title + '<nobr/></a></a> </li>';
        //是否允许关闭
        //if (options.close) {
        //    title += ' <i class="glyphicon glyphicon-remove" tabclose="' + id + '"></i>';
        //}
        //title += '</a></li>';
       /* title = '<li id=tabtitle_' + id + '><a href="#tab_' + id + '" data-toggle="tab">' + options.title + '</a><a href="javascript:;" class="icon-remove"></a></li>';
        //是否允许关闭
        //if (options.close) {
        //    title += ' <i class="glyphicon glyphicon-remove" tabclose="' + id + '"></i>';
        //}
        ...
        if (options.content) {
             ...
             */
            content = '<div class="tab-pane" style="height:100%" id="tab_' + id + '"><iframe id=ifr_' + id + ' name=ifr_' + id + ' src="' + options.url + '" width="100%" height="100% "' +
